...
from TFWMUSIC.utils.decorators.language import language
from TFWMUSIC.utils.formatters import alpha_to_int
from config import adminlist
import random
from typing import Dict, List, Union

from TFWMUSIC import userbot
from TFWMUSIC.core.mongo import mongodb, pymongodb
        ...
        try:
            ...
            for chat_id in served_chats:
                if chat_id not in adminlist:
                    adminlist[chat_id] = []
                    async for user in Client.get_chat_members( #change done 
