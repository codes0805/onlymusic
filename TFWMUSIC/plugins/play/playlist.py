...
from TFWMUSIC import Carbon, app
from TFWMUSIC.utils.decorators.language import language, languageCB
from TFWMUSIC.utils.inline.playlist import (
    botplaylist_markup,
    get_playlist_markup,
    warning_markup,
)
...
from TFWMUSIC.core.mongo import mongodb
...
@app.on_callback_query(filters.regex("TFW_playlist") & ~BANNED_USERS)
@languageCB
